...
wnba_gl |>
  select(z_quality_of_play, z_uncertain_outcome, z_loss_aversion) |>
...
```{r}
f_control <- "factor(season_id) + factor(wday(game_date)) + factor(month(game_date)) + factor(arena) + median_income + median_pop + is_cc + is_aw"
